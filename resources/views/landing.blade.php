...
<head>
    ...
    <meta name="description"
        content="Gestiona clientes, facturas CFDI y obligaciones fiscales desde un solo panel. Hecho para contadores en México.">
...
<body>
    ...
    <section id="features">
        <div class="section-inner">
            ...
            <p class="section-sub">Diseñado con los flujos reales de un contador mexicano, no con funciones genéricas.
            </p>
    ...
    <section id="pricing" class="pricing-section">
        <div class="section-inner">
            ...
            <p class="section-sub" style="margin: 0 auto;">Sin límites de clientes, sin funciones bloqueadas, sin planes
                confusos. Todo incluido desde el primer día.</p>
